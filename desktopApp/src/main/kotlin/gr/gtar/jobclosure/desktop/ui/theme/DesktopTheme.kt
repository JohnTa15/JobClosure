package gr.gtar.jobclosure.desktop.ui.theme
...
/**
 * The four switchable colour themes from the Android restyle design handoff.
 * Booking-type accents (see [typeColors]) are fixed and never change with this.
 */
...
/**
 * Fixed per-booking-type colour identity from the design handoff - unlike [AppTheme], these
 * never change with the user's theme choice, so a wedding card is always gold and a baptism card
 * is always pink regardless of which of the 4 app themes is active.
 */
@Immutable
